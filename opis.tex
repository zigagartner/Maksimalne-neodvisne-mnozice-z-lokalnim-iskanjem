...
\begin{titlepage}
    \begin{center}
        ...
        {\huge Največja neodvisna množica z lokalnim iskanjem}\\[10.0cm]
    \end{center}
...
$$ x_{u} \in \{0, 1 \} \ za \ \forall u \in V.$$
\end{posledica}

Največjo neodvisno množico v množici vseh neodvisnih podmnožic grafa $G = (V,E)$ bomo iskali s pomočjo celoštevilskega lineranega programiranja in lokalnega iskanja. Lokalno iskanje temelji na
