...
\begin{definicija}
    Naj bo $G = (V,E)$ graf. \textbf{Neodvisna množica} $U$, v grafu $G$, je taka podmnožica množice vozlišč $V$, kjer poljubni dve vozlišči iz množice $U$ nista sosednji. Torej:
        $$U = \{u \in V | e(v,w) \notin E \ za \ \forall v,w \in U \}.$$
    \textbf{Največja neodvisna množica} v grafu $G$ pa je taka neodvisna množica, kjer ne obstaja vozlišče $v \in V$ in $v \notin U$, ki bi ga lahko dodali množici $U$ in pri tem ohranili neodvisnost množice $U$. Torej
...
da velja:
$$ x_{u} + x_{v} \leq 1 \ za \ \forall uv \in E,$$
$$ x_{u} \in \{0, 1 \}$$
$$ x_{u} = 
    \begin{cases}
    1, \ za \ u \in H \\
    0, \ za \ u \notin H
    \end{cases}, \text{H neodvisna množica v grafu G.}
$$
\end{posledica}
