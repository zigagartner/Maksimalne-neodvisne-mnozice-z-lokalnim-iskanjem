...
\textit{Erdős-Rényijevega}$G(n,p)$ modela. Primerjali bomo maksimalne (ali pa največje) neodvisne množice, ki jih algoritmi poiščejo,
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[scale = 0.13]{R_koda/pon-moc-maximalno.png}
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[scale=0.13]{R_koda/pon-casi-maxi.png}
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[scale=0.13]{R_koda/voz-moc.png}
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[scale=0.14]{R_koda/voz-cas.png}
...
Torej velikost maksimalne neodvisne množice ni odvisna le od števila vozlišč v grafu, ampak tudi od števila povezav. Ugotovitve so opazne na spodnjem grafu 10.\\
=======
...
>>>>>>> a1871a08d8963f9c73e30bee1e9d7ceab237d1a2
...
$nakljucni\_MIS$ in $lokalnim\ iskanjem$. Graf 11 to nazorno prikazuje in potrjuje.
